    ...
    <body>
        ...
        <body>
            <div class="w-screen flex">
                ...
                <aside id="sidebar-multi-level-sidebar" class="w-[20rem]"
                    class="fixed top-auto left-0 z-40 w-64 h-full transition-transform -translate-x-full sm:translate-x-0"
                    aria-label="Sidebar">
                    <div class="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800 relative">
                        ...
                        <div class="absolute bottom-0">
                            <button type="button" name="add" id="add"
                                class="w-[16rem] px-auto py-2 text-white bg-indigo-500 rounded-md  focus:bg-indigo-600 focus:outline-none">Add
                                More</button>
                        </div>
                    </div>
                </aside>
