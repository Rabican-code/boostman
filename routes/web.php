...
Route::get('/campaign_item/contacts/{id}', [App\Http\Controllers\ContactsController::class, 'campaignItemContactShow']);
Route::post('/addcontact', [App\Http\Controllers\ContactsController::class, 'store']);

Route::post('/addcampaigncontact/{id}', [App\Http\Controllers\ContactsController::class, 'campaignItemContactStore']);
